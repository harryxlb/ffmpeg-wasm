...
// end include: preamble.js
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(29, 1, len,prot,flags,fd,offset_low, offset_high,allocated,addr);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(30, 1, addr,len,prot,flags,fd,offset_low, offset_high);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(36, 1, fd,offset_low, offset_high,whence,newOffset);
...
var dynCall_viiiiijjidd = Module['dynCall_viiiiijjidd'] = createExportWrapper('dynCall_viiiiijjidd');
...
var _ff_h264_cabac_tables = Module['_ff_h264_cabac_tables'] = 1441468;
